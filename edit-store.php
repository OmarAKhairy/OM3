...
if(isset($_POST['submit'])){
   ...
   $IP = $_POST['ip'];
    ...
    $query = "UPDATE stores SET store_name= '".$name."', store_ip='".$IP."' WHERE store_id = ".$storeID."";

    if(mysqli_query($conn, $query)){
        header("Location: http://www.om3.tech/store.php?id=".$storeID."&name=".$name."&ip=".$IP."");
        exit;
    }else{
          ...
          <div class="jumbotron">
            ...
            <h1>Edit Store</h1>
              <div class="form-group">
                <input type="text" class="form-control" id="name" name="name" placeholder="Enter the store name" value="<?php echo $storeName; ?>">
              </div>
              <div class="form-group">
                <input type="text" class="form-control" id="ip" name="ip" placeholder="Enter the store IP address" value="<?php echo $storeIP; ?>">
              </div>
