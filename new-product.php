...
if(isset($_POST['submit'])){
   ...
   $tag = $_POST['tag'];
    ...
    $query = "INSERT INTO products(product_name, tag_id, product_count) VALUES('$name', '$tag', '0')";
    
    if(mysqli_query($conn, $query)){
        
        $query2 = "SELECT * FROM products WHERE product_name='".$name."'";
        ...
        $query3 = "INSERT INTO stores_products(store_id, product_id) VALUES('$storeID', '$productID')";
